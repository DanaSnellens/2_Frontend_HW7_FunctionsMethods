...
const ArrayOne = cumLaude(grades);
const ArrayTwo = cumLaude([6, 4, 5])
const ArrayThree = cumLaude([8, 9, 4, 6, 10])
...
console.log(averageOne.toFixed(2), averageTwo.toFixed(2), averageThree.toFixed(2));
